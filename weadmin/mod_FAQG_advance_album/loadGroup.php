                                    ...
                                    <?php if ($valPermissionContent == "RW") { ?>
                                        <div id="load_status<?php echo $valID ?>">
                                            <?php if ($valStatus == "Enable") { ?>
                                                ...
                                                <a href="javascript:void(0)" onclick="changeStatusHome('load_waiting<?php echo $valID ?>','<?php echo $mod_tb_root_group ?>','<?php echo $valStatus ?>','<?php echo $valID ?>','load_status<?php echo $valID ?>','../<?php echo $mod_fd_root ?>/statusMg.php','<?php echo $_REQUEST['masterkey'] ?>')"><span class="<?php echo $valStatusClass ?>"><?php echo $valStatus ?></span></a>

                                            <?php } elseif ($valStatus == "Home") { ?>
                                                <a href="javascript:void(0)" onclick="changeStatusHome('load_waiting<?php echo $valID ?>','<?php echo $mod_tb_root_group ?>','<?php echo $valStatus ?>','<?php echo $valID ?>','load_status<?php echo $valID ?>','../<?php echo $mod_fd_root ?>/statusMg.php','<?php echo $_REQUEST['masterkey'] ?>')">
                                    ...
                                    <?php if ($valPermissionContent == "RW") { ?>
                                        <div id="load_status<?php echo $valID ?>">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <a href="javascript:void(0)" onclick="changeStatus('load_waiting<?php echo $valID ?>','<?php echo $mod_tb_root_group ?>','<?php echo $valStatus ?>','<?php echo $valID ?>','load_status<?php echo $valID ?>','../<?php echo $mod_fd_root ?>/statusMg.php')">
                                                    <span class="<?php echo $valStatusClass ?>"><?php echo $valStatus ?></span> </a>
