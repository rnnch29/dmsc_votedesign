...
<head>
	...
	<script language="JavaScript" type="text/javascript">
		function executeSubmit() {
			...
			// updateContactNew('updatePic.php');
		...
		<div class="divRightMain">
			...
			<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
				...
				<tr>
					...
					<td colspan="6" align="left" valign="top" class="formRightContantTb">
						<textarea name=
						"inputDescription" id="inputDescription" cols="45" rows="5" class="formTextareaContantTb"><?php echo $valTitle ?></textarea>
					</td>
				</tr>
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ckabout"
                ...
                <tr>
					...
					<td align="left">
						<table border="0" cellspacing="0" cellpadding="0" align="right" style="padding-right: 20px;">
							<tr>
								<td align="right">
								<?php if ($valPermission == "RW") { ?>
									<div class="btnSort" title="<?= $langTxt["btn:sortting"] ?>" onclick=" document.myFormHome.inputLt.value = '<?= $_REQUEST['inputLt'] ?>';
                                                        document.myFormHome.valEditID.value=<?= $valID ?>;sortContactNew('sortPic.php');"></div>
									<?php } ?>
                ...
                <tr>
                    ...
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                        ...
                        <div id="boxAlbumNew" class="formFontTileTxt">
							...
							$sql_filetemp = "SELECT  ";
							if ($_REQUEST['inputLt'] == "Thai") {
								$sql_filetemp .= $mod_tb_root_album . "_id  ," . $mod_tb_root_album . "_filename,
								" . $mod_tb_root_album . "_name,
								" . $mod_tb_root_album . "_download ";
    
							} elseif ($_REQUEST['inputLt'] == "Eng") {
								$sql_filetemp .= $mod_tb_root_album . "_id  ," . $mod_tb_root_album . "_filenameen,
								" . $mod_tb_root_album . "_nameen,
								" . $mod_tb_root_album . "_downloaden ";
							}  
							$sql_filetemp .= " FROM " . $mod_tb_root_album . " WHERE " . $mod_tb_root_album . "_contantid 	='" . $_REQUEST['valEditID'] . "'
							AND " . $mod_tb_root_album . "_lang".$lang." = '1'  
							...
							if ($number_filetemp >= 1) {
								$valAlbum = "";
								// $valAlbum .= "<ul class='listImggallery'>";
								while ($row_filetemp = wewebFetchArrayDB($coreLanguageSQL, $query_filetemp)) {
									...
									// $valAlbum .= "<label>" . $langMod["tit:imgDe"] . "<br><input name='imgalb[" . $downloadID . "]' value='" . $downloadName . "'/></label>";
