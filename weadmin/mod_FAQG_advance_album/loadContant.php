...
<head>
  ...
  <script language="JavaScript" type="text/javascript" src="./js/script.js?v=10001"></script>
</head>
...
<script>
  jQuery(document).ready(function() {
    var GroupID = $('#inputGhSubSel :selected').val();
			if (GroupID > 0) {
				onChangeSelectHome('openSelectSubContent.php','#subgroup');
			}
  });
</script>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;" align="center">
        ...
        <tr>
          <td style="padding-right:10px;" width="30%">
            <select name="inputGh" id="inputGhSubSel" onchange="$( '#myForm #inputGh2' ).val('0').change();" class="formSelectSearchStyle">
          ...
          <td id="boxSelectTest" width="99%">
            <input name="inputSearch" type="text" id="inputSearch" value="<?php echo trim($_REQUEST['inputSearch']) ?>" class="formInputSearchI" placeholder="<?php echo $langTxt["sch:search"] ?>" style="min-width: 500px;" />
          </td>
