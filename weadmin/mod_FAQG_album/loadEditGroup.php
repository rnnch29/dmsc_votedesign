...
$sql .= " ,  " . $mod_tb_root_group . "_langth as langth," . $mod_tb_root_group . "_langen as langen  FROM " . $mod_tb_root_group . " WHERE " . $mod_tb_root_group . "_masterkey='" . $_POST["masterkey"] . "' AND  " . $mod_tb_root_group . "_id 	='" . $_POST["valEditID"] . "'";
