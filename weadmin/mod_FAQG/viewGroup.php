...
$sql .= " ,
" . $mod_tb_root_group . "_langth as langth,
" . $mod_tb_root_group . "_langen as langen  FROM " . $mod_tb_root_group . " WHERE " . $mod_tb_root_group . "_masterkey='" . $_REQUEST["masterkey"] . "'  AND  " . $mod_tb_root_group . "_id='" . $_REQUEST['valEditID'] . "' ";
// print_r($sql);die();
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        <tr>
          <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
            ...
            <span class="formFontTileTxt"><?php echo $langMod["txt:subjectgDe2"] ?></span>
          </td>
        </tr>
