...
if ($_SESSION[$valSiteManage . "core_session_language"] == "Eng") {
   ...
   // $langMod = checkpageText($langMod);
    ...
    $langMod["txt:king"] = "ข้อมูลจัดการปุ่มอื่นๆ";
    $langMod["txt:kingDe"] = "ข้อมูลนี้คือส่วนที่ใช้ในการตั้งค่าเว็บไซต์ในเว็บไซต์ของคุณ";
    $langMod["tit:kingopenclose"] = "การใช้งาน";
    $langMod["tit:kingbtnname"] = "ชื่อปุุุ่ม";
    $langMod["tit:kingurl"] = "ลิงค์";
    $langMod["tit:kingdisplay"] = "การแสดงผล";
    $langMod["tit:kingnote"] = 'หมายเหตุ : กรุณา URL นำหน้าด้วย "http://" เช่น http://www.wewebplus.com เป็นต้น';
}
