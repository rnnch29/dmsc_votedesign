        ...
        <div class="divRightMain">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
                <tr>
                    ...
                    <td align="left" width="25%" valign="middle" class="divRightTitleTb"><span
                            class="fontTitlTbRight"><?php echo $langMod["tit:subject"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>(<?php echo $langTxt["lg:thai"] ?>)<?php } ?></span>
                    </td>
                    <?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>
                    <td align="left" width="25%" valign="middle" class="divRightTitleTb"><span
                            class="fontTitlTbRight"><?php echo  $langMod["tit:subject"] ?>
                            (<?php echo  $langTxt["lg:eng"] ?>)</span></td>
                    <?php } ?>
                            ...
                            <tr>
                                <td class="displayTdImg" align="left" valign="top">
                                    <div class="displayClickImg"
                                        style=" background:url(<?php echo  $valPic ?>) center no-repeat;"></div>
                                </td>
                    ...
                    <td class="divRightContantOverTb" valign="top" align="left">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="displayTdImg" align="left" valign="top">
                                    <div class="displayClickImg"
                                        style=" background:url(<?php echo  $valPicEN ?>) center no-repeat;border-radius: 50%;">
                                    </div>
                                </td>
                                <td align="left"><a href="javascript:void(0)" onclick="
                    ...
                    <td class="divRightContantOverTb" valign="top" align="center">
                        ...
                        <div id="load_status<?php echo  $valID ?>">
                            ...
                            <a href="javascript:void(0)"
                                onclick="changeStatus('load_waiting<?php echo  $valID ?>', '<?php echo  $mod_tb_root ?>', '<?php echo  $valStatus ?>', '<?php echo  $valID ?>', 'load_status<?php echo  $valID ?>', '../<?php echo  $mod_fd_root ?>/statusMg.php')"><span
                                    class="<?php echo  $valStatusClass ?>"><?php echo  $valStatus ?></span></a>

                            <?php } else { ?>

                            <a href="javascript:void(0)"
                                onclick="changeStatus('load_waiting<?php echo  $valID ?>', '<?php echo  $mod_tb_root ?>', '<?php echo  $valStatus ?>', '<?php echo  $valID ?>', 'load_status<?php echo  $valID ?>', '../<?php echo  $mod_fd_root ?>/statusMg.php')">
