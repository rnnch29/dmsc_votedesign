...
$valPicName = $Row['pic'];
$valPics = $mod_path_pictures . "/" . $Row['pic'];
    ...
    <form action="?" method="get" name="myForm" id="myForm">
        ...
        <div class="divRightMain">
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                ...
                <?
                // var_dump($valLang);
                // var_dump($modTxtSetLang);
                // echo $langMod["set:lang:web"];
                ?>
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                ...
                <tr>
                    ...
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                        <div class="formDivView">
                            <?php if (is_file($valPics)) { ?>
                                <a href="<?php echo $valPics ?>" target="_blank"><img style="float:left;border:#c8c7cc solid 1px;max-width:650px;" src="<?php echo $valPics ?>" /></a>
