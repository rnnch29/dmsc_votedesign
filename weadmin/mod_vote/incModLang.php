...
if($_SESSION[$valSiteManage."core_session_language"]=="Eng"){
		...
		// Question
		$langMod["txt:q1"] = "1. ชอบธีมไหนมากที่สุด";
		$langMod["txt:q2"] = "2. ลำดับการแสดงผล บริการ / วิจัย ควรนำหัวข้อใดขึ้นก่อน";
		$langMod["txt:q3"] = "3. ส่วนของบริการ ชอบธีมไหนมากที่สุด";
