...
include("config.php");
$valuPathRealFile= getFileNameReal(_getURL());
$valueActionFile = $_REQUEST['actionFile'];
 if ($_SESSION[$valSiteManage . "core_session_level"] !== "SuperAdmin" && $_SESSION[$valSiteManage . "core_session_level"] !== "admin") {
	 header( "Location:../index.php"); 	
 }
//print_pre($valueActionFile);

switch ($valueActionFile) {
  case "transfer":
    $valueActionFileCode = "updateContant.php";
    break;
  default:
    $valueActionFileCode = "loadContant.php";
}
...
<link href="../css/theme.css<?php echo $core_cache_browser;?>" rel="stylesheet"/>
...
<script type="text/javascript">
	jQuery(function() {
		boxContantLoad('../<?php echo $mod_fd_root?>/<?php echo $valuPathRealFile;?>/<?php echo $valueActionFileCode;?>');
	});
</script>
     ...
     <div class="mainBackOffice">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                ...
                <input name="actionFile" type="hidden" id="actionFile" value="<?php echo $valueActionFile;?>" />
